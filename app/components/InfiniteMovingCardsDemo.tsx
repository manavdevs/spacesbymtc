...
export function InfiniteMovingCardsDemo() {
  return (
    <div className="relative h-[18rem] rounded-md flex flex-col antialiased bg-black dark:bg-black dark:bg-grid-black/[0.05] items-center justify-center overflow-hidden">
      <InfiniteMovingCards
        items={testimonials}
        direction="right"
        speed="slow"
